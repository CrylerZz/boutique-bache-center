...
!function(t, e) {
    ...
    function p(t) {
        ...
        if (y = window,
            ...
            a = (g = e).documentElement,
                b = e.body,
                (s = g.createElementNS("http://www.w3.org/2000/svg", "g")).style.transform = "none";
            var i = e.createElement("div")
                , n = e.createElement("div")
                , r = e && (e.body || e.firstElementChild);
            r && r.appendChild && (r.appendChild(i),
                i.appendChild(n),
    ...
    function x(t, e) {
        if (t.parentNode && (g || p(t))) {
            ...
            return e && (i ? (f = f || x(t),
                ...
                f.appendChild(l)) : (c || ((c = x(t)).style.cssText = o),
                l.style.cssText = o + "width:0.1px;height:0.1px;top:" + s + "px;left:" + a + "px",
                c.appendChild(l))),
                l
        }
    ...
    function z(t) {
        var e, i = t.getCTM();
        return i || (e = t.style[w],
            t.style[w] = "none",
            t.appendChild(s),
            i = s.getCTM(),
            t.removeChild(s),
            e ? t.style[w] = e : t.style.removeProperty(w.replace(/([A-Z])/g, "-$1").toLowerCase())),
        i || d.clone()
    }
    function A(t, e) {
        ...
        if (t === y)
            return t;
        if (p.length || p.push(x(t, 1), x(t, 2), x(t, 3)),
            i = l ? f : c,
            l)
            u ? (a = -(r = z(t)).e / r.a,
                s = -r.f / r.d,
                n = d) : t.getBBox ? (r = t.getBBox(),
                a = (n = (n = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < n.numberOfItems ? function _consolidate(t) {
                    for (var e = new M, i = 0; i < t.numberOfItems; i++)
                        e.multiply(t.getItem(i).matrix);
                    return e
                }(n) : n.getItem(0).matrix : d).a * r.x + n.c * r.y,
                s = n.b * r.x + n.d * r.y) : (n = new M,
                a = s = 0),
            ...
            if (a = s = 0,
                ...
                for (n = t.offsetParent,
                    ...
                    4 < (y.getComputedStyle(r)[w] + "").length && (a = r.offsetLeft,
                        s = r.offsetTop,
                        r = 0);
    ...
    function ja(e, i, n) {
        ...
        tt && 1 !== n)
            return tt._abs.push({
                ...
                o;
        for (a = "none" === c("display"),
             e.isVisible && !a || (a && (fa(e, ["display"]).display = i.display),
                 e.matrix = i.matrix,
                 e.width = l = e.width || i.width,
                 e.height = p = e.height || i.height),
                 fa(e, R),
                 s = window.getComputedStyle(o); d--; )
            f[R[d]] = s[R[d]];
        if (f.gridArea = "1 / 1 / 1 / 1",
            f.transition = "none",
            f.position = "absolute",
            f.width = l + "px",
            f.height = p + "px",
        ...
        f.left || (f.left = "0px"),
            h)
            r = new pt(o);
        else if ((r = _(e, D)).position = "absolute",
            e.simple) {
            var m = o.getBoundingClientRect();
            r.matrix = new M(1,0,0,1,m.left + u(),m.top + t())
        } else
            r.matrix = getGlobalMatrix(o, !1, !1, !0);
        return r = ot(r, e, !0),
            e.x = P(r.x, .01),
            e.y = P(r.y, .01),
            o
    ...
    function za(t) {
        if (t !== l) {
            ...
            if (t && (i || n)) {
                for (; r--; )
                    j[r] = e[H[r]];
                i && (e.width = o.clientWidth + "px",
                    e.overflowY = "hidden"),
                n && (e.height = o.clientHeight + "px",
                    e.overflowX = "hidden"),
                    l = t
            } else if (l) {
                for (; r--; )
                    j[r] ? e[H[r]] = j[r] : e.removeProperty($(H[r]));
                l = t
            }
        }
    }
    function Aa(t, e, r, i) {
            ...
            m = function run() {
                for (ea(H),
                    ...
                    p = H[l],
                        g = p.a,
                        v = p.b,
                        !D || g.isDifferent(v) || p.entering ? (u = p.t,
                        !I || p.sd < 0 || !l || (g.matrix = getGlobalMatrix(u, !1, !1, !0)),
                            v.isVisible && g.isVisible ? (p.sd < 0 ? (h = new pt(u,Y,t.simple),
                                ot(h, g, A, 0, 0, h),
                                h.matrix = getGlobalMatrix(u, !1, !1, !0),
                                h.css = p.b.css,
                                p.a = g = h,
                            T && (u.style.opacity = J ? v.opacity : g.opacity),
                            O && q.push(u)) : 0 < p.sd && T && (u.style.opacity = J ? g.opacity - v.opacity : "0"),
                                ot(g, v, A, Y)) : v.isVisible !== g.isVisible && (v.isVisible ? g.isVisible || (v.css = g.css,
                                j.push(v),
                                H.splice(l--, 1),
                            S && I && ot(g, v, A, Y)) : (g.isVisible && G.push(g),
                                H.splice(l--, 1))),
                        A || (u.style.maxWidth = Math.max(g.width, v.width) + "px",
                        ...
                        I && L && u.classList.add(L)) : H.splice(l--, 1),
                        f.push(g);
                var e;
                ...
                C && c.length)
                    ...
                    "scale"in C && (C.scaleX = C.scaleY = C.scale,
                        ...
                        C)
                        (a = _(C[s], at))[s] = z[s],
                        !("duration"in a) && "duration"in z && (a.duration = z.duration),
                            a.stagger = z.stagger,
                            U.call(R, c, a, 0),
                            delete W[s];
        ...
        k && (S = H.filter(function(t) {
            ...
            tt ? (S && (y = tt._abs).push.apply(y, ka(H, S)),
                tt._run.push(m)) : (S && la(ka(H, S)),
                m());
    ...
    var I, Q, tt, r, o, P, T, l, n, h = 1, F = {}, O = 180 / Math.PI, N = Math.PI / 180, D = {}, Y = {}, et = {}, it = S("onStart,onUpdate,onComplete,onReverseComplete,onInterrupt"), nt = S("transform,transformOrigin,width,height,position,top,left,opacity,zIndex,maxWidth,maxHeight,minWidth,minHeight"), rt = {
        ...
        return F || !m ? (b = w = 1,
            S = s = 0) : (h = (p = function _getInverseGlobalMatrix(t) {
            var e = t._gsap || Q.core.getCache(t);
            return e.gmCache === Q.ticker.frame ? e.gMatrix : (e.gmCache = Q.ticker.frame,
                e.gMatrix = getGlobalMatrix(t, !0, !1, !0))
        }(m)).clone().multiply(e.ctm ? e.matrix.clone().multiply(e.ctm) : e.matrix),
            S = W(Math.atan2(h.b, h.a) * O),
            s = W(Math.atan2(h.c, h.d) * O + S) % 360,
            b = Math.sqrt(Math.pow(h.a, 2) + Math.pow(h.b, 2)),
            w = Math.sqrt(Math.pow(h.c, 2) + Math.pow(h.d, 2)) * Math.cos(s * N),
        r && (r = I(r)[0],
            u = Q.getProperty(r),
            ...
            d.rotation = S + "deg",
            d.skewX = s + "deg"),
            i ? (b *= y !== C.width && C.width ? y / C.width : 1,
                w *= x !== C.height && C.height ? x / C.height : 1,
                d.scaleX = b,
                d.scaleY = w) : (y = P(y * b / C.scaleX, 0),
                x = P(x * w / C.scaleY, 0),
                f.style.width = y + "px",
                f.style.height = x + "px"),
        n && pa(f, e.props),
            F || !m ? (g += E - t.matrix.e,
                v += M - t.matrix.f) : B || m !== e.parent ? (d.renderTransform(1, d),
            ...
            g = P(g, .02),
            v = P(v, .02),
            !a || a instanceof pt ? (d.x = g + "px",
                d.y = v + "px",
                d.renderTransform(1, d)) : _ && _.revert(),
        a && (a.x = g,
            a.y = v,
            a.rotation = S,
            a.skewX = s,
            i ? (a.scaleX = b,
                a.scaleY = w) : (a.width = y,
                a.height = x)),
        a || d
    }, j = [], H = "width,height,overflowX,overflowY".split(","), lt = function _killFlip(t, e, i) {
        if (t && t.progress() < 1 && (!t.paused() || i))
            return e && (function _interrupt(t) {
        ...
        n.add = function add(t) {
            for (var e, i, n, r = t.targets.length, a = this.idLookup, s = this.alt; r--; )
                (n = a[(i = t.elementStates[r]).id]) && (i.element === n.element || s[i.id] && s[i.id].element === i.element) ? (e = this.elementStates.indexOf(i.element === n.element ? n : s[i.id]),
                    this.targets.splice(e, 1, t.targets[r]),
                    this.elementStates.splice(e, 1, i)) : (this.targets.push(t.targets[r]),
        ...
        n.compare = function compare(t) {
            ...
            for (n in u)
                a = g[n],
                    ...
                    i = p[n],
                    s ? (l = i.isVisible || !s.isVisible && r === i.element ? i : s,
                        (o = !a || e.isVisible || a.isVisible || l.element !== a.element ? e : a).isVisible && l.isVisible && o.element !== l.element ? ((o.isDifferent(l) ? c : h).push(o.element, l.element),
                            m.push(o.element, l.element)) : kh(o, l, o.element),
                    a && o.element === a.element && (a = u[n]),
                        lh(o.element !== i.element && a ? a : o, i, i.element),
                        lh(a && a.element === s.element ? a : o, s, s.element),
                    a && lh(a, s.element === a.element ? s : i, a.element)) : (i ? i.isDifferent(e) ? kh(e, i, r) : h.push(r) : f.push(r),
                    a && lh(a, i, a.element));
            for (n in p)
                u[n] || (d.push(p[n].element),
                v[n] && d.push(v[n].element));
            return {
                changed: c,
                unchanged: h,
                enter: f,
        ...
        q.update = function update(e, i) {
            ...
            n.getProp = a,
                ...
                n.id = function _getID(t) {
                    ...
                    return e || t.setAttribute("data-flip-id", e = "auto-" + h++),
                        e
                }(r),
                n.matrix = p,
                n.cache = s,
                ...
                n.skewX = a("skewX"),
                n.opacity = a("opacity"),
                n.width = l ? l.width : P(a("width", "px"), .04),
                n.height = l ? l.height : P(a("height", "px"), .04),
            e && function _recordProps(t, e) {
                for (var i = Q.getProperty(t.element, null, "native"), n = t.props = {}, r = e.length; r--; )
                    n[e[r]] = (i(e[r]) + "").trim();
                n.zIndex && (n.zIndex = parseFloat(n.zIndex) || 0)
            }(n, st[e] || ba(e)),
                n.ctm = r.getCTM && "svg" === r.nodeName.toLowerCase() && z(r).inverse(),
                n.simple = i || 1 === W(p.a) && !W(p.b) && !W(p.c) && 1 === W(p.d),
                n.uncache = 0
        }
        ,
        ElementState);
    ...
    var U, K = ((U = FlipBatch.prototype).add = function add(e) {
        ...
        U.remove = function remove(t) {
            ...
            return 0 <= e && this.actions.splice(e, 1),
                this
        }
        ,
        ...
        U.run = function run(t, e) {
            var i = this;
            return this !== tt && (t || this.getState(e),
        ...
        U.getStateById = function getStateById(t) {
            for (var e, i = this.actions.length; i--; )
                if (e = this.actions[i].getStateById(t))
                    return e;
    ...
    var ht = (Flip.getState = function getState(t, e) {
        ...
        Flip.fit = function fit(t, e, i) {
            var n = i ? _(i, at) : {}
                ...
                , m = l ? et[l] : nt
                , g = Q.context();
            return l && pa(n, f.props),
                fa(d, m),
            u && ("immediateRender"in n || (n.immediateRender = !0),
    ...
    function Flip() {}
    ht.version = "3.12.5",
    "undefined" != typeof window && window.gsap && window.gsap.registerPlugin(ht),
        e.Flip = ht,
        e.default = ht;
