...
!function(t, e) {
    ...
    function C(t, e) {
        var n = t.length
            , r = t[n - 1] || []
            , a = r.length;
        n && e[0] === r[a - 2] && e[1] === r[a - 1] && (e = r.concat(e.slice(2)),
            n--),
            t[n] = e
    }
    ...
    function getRawPath(t) {
        ...
        return n && (t = t.getAttribute("d")) ? (n._gsPath || (n._gsPath = {}),
            (e = n._gsPath[t]) && !e._dirty ? e : n._gsPath[t] = stringToRawPath(t)) : t ? p(t) ? stringToRawPath(t) : h(t[0]) ? [t] : t : console.warn("Expecting a <path> element or an SVG path data string")
    }
    ...
    function convertToPath(t, e) {
        var n, r, a, o, i, s, l, h, u, f, g, c, p, d, m, v, y, x, w, P, b, M, R = t.tagName.toLowerCase(), L = .552284749831;
        return "path" !== R && t.getBBox ? (s = function _createPath(t, e) {
            ...
            "rect" === R ? (o = M.rx,
                ...
                f = M.width - 2 * o,
                g = M.height - 2 * i,
                n = o || i ? "M" + (v = (d = (p = r + o) + f) + o) + "," + (x = a + i) + " V" + (w = x + g) + " C" + [v, P = w + i * L, m = d + o * L, b = w + i, d, b, d - (d - p) / 3, b, p + (d - p) / 3, b, p, b, c = r + o * (1 - L), b, r, P, r, w, r, w - (w - x) / 3, r, x + (w - x) / 3, r, x, r, y = a + i * (1 - L), c, a, p, a, p + (d - p) / 3, a, d - (d - p) / 3, a, d, a, m, a, v, y, v, x].join(",") + "z" : "M" + (r + f) + "," + a + " v" + g + " h" + -f + " v" + -g + " h" + f + "z") : "circle" === R || "ellipse" === R ? (h = "circle" === R ? (o = i = M.r) * L : (o = M.rx,
            (i = M.ry) * L),
                n = "M" + ((r = M.cx) + o) + "," + (a = M.cy) + " C" + [r + o, a + h, r + (l = o * L), a + i, r, a + i, r - l, a + i, r - o, a + h, r - o, a, r - o, a - h, r - l, a - i, r, a - i, r + l, a - i, r + o, a - h, r + o, a].join(",") + "z") : "line" === R ? n = "M" + M.x1 + "," + M.y1 + " L" + M.x2 + "," + M.y2 : "polyline" !== R && "polygon" !== R || (n = "M" + (r = (u = (t.getAttribute("points") + "").match(T) || []).shift()) + "," + (a = u.shift()) + " L" + u.join(","),
            "polygon" === R && (n += "," + r + "," + a + "z")),
    ...
    function sliceRawPath(t, e, n) {
        ...
        var i, s, l, h, u, f, g, c, p = 1 < n, d = getProgressData(a, e, S, !0), m = getProgressData(a, n, _), v = m.segment, w = d.segment, P = m.segIndex, b = d.segIndex, M = m.i, R = d.i, L = b === P, T = M === R && L;
        if (p || r) {
            for (i = P < b || L && M < R || T && m.t < d.t,
                 y(a, b, R, d.t) && (b++,
                 i || (P++,
                     T ? (m.t = (m.t - d.t) / (1 - d.t),
                         M = 0) : L && (M -= R))),
                ...
                C(u, a[c++ % f]);
            a = u
        } else if (l = 1 === m.t ? 6 : subdivideSegment(v, M, m.t),
        e !== n)
            for (s = subdivideSegment(w, R, T ? d.t / m.t : d.t),
                 L && (l += s),
                     v.splice(M + l + 2),
                 (s || R) && w.splice(0, R + s),
                     h = a.length; h--; )
    ...
    function measureSegment(t, e, n) {
        ...
        t.samples || (t.samples = [],
            t.lookup = []);
        var r, a, o, i, s, l, h, u, f, g, c, p, d, m, v, y, x, w = ~~t.resolution || 12, P = 1 / w, b = n ? e + 6 * n + 1 : t.length, M = t[e], R = t[e + 1], L = e ? e / 6 * w : 0, T = t.samples, C = t.lookup, S = (e ? t.minLength : A) || A, _ = T[L + n * w - 1], N = e ? T[L - 1] : 0;
        for (T.length = C.length = 0,
                 a = e + 2; a < b; a += 6) {
            if (o = t[a + 4] - M,
                i = t[a + 2] - M,
                s = t[a] - M,
        ...
        if (_)
            for (_ -= N; L < T.length; L++)
                T[L] += _;
        if (T.length && S) {
            if (t.totalLength = x = T[T.length - 1] || 0,
            x / (t.minLength = S) < 9999)
                for (y = v = 0,
                         r = 0; r < x; r += S)
                    C[y++] = T[v] < r ? ++v : v
        } else
    ...
    function getPositionOnPath(t, e, n, r) {
        ...
        if ((e < 0 || 1 < e) && (e = d(e)),
        c.lookup || cacheRawPathMeasurements(t),
        1 < t.length) {
            for (i = t.totalLength * e,
                     l = h = 0; (l += t[h++].totalLength) < i; )
                c = t[h];
        ...
        return a = c.samples,
            o = c.resolution,
            i = c.totalLength * e,
            s = (h = c.lookup.length ? c.lookup[e < 1 ? ~~(i / c.minLength) : c.lookup.length - 1] || 0 : m(a, i, e)) ? a[h - 1] : 0,
        (l = a[h]) < i && (s = l,
            l = a[++h]),
    ...
    function arcToSegment(t, e, n, r, a, o, i, s, l) {
        if (t !== s || e !== l) {
            ...
            isNaN(I) && (I = g),
                ...
                E %= c,
                I %= c;
            var D, X = Math.ceil(H(I) / (c / 4)), k = [], z = I / X, G = 4 / 3 * F(z / 2) / (1 + U(z / 2)), Z = u * n, q = f * n, Y = f * -r, j = u * r;
            for (D = 0; D < X; D++)
                m = U(a = E + D * z),
                    v = F(a),
                    _ = U(a += z),
    ...
    function stringToRawPath(t) {
        ...
        }).match(M) || [], v = [], y = 0, x = 0, w = m.length, P = 0, b = "ERROR: malformed path: " + t;
        ...
        for (e = 0; e < w; e++)
            ...
            "M" === o)
                ...
                Cf(y, x, y, x = r + (i ? x - y : 0)),
                    e += 1;
            else if ("L" === o || "Z" === o)
                "Z" === o && (r = l,
                    a = h,
                    s.closed = !0),
                ("L" === o || .5 < H(y - r) || .5 < H(x - a)) && (Cf(y, x, r, a),
                "L" === o && (e += 2)),
                    y = r,
                    x = a;
            else if ("A" === o) {
    ...
    function pointsToSegment(t, e) {
        ...
        var n, r, a, o, i, s, l, h, u, f, g, c, p, d, m = t.length - 2, v = +t[0], y = +t[1], x = +t[2], w = +t[3], P = [v, y, v, y], b = x - v, M = w - y, R = Math.abs(t[m] - v) < .001 && Math.abs(t[m + 1] - y) < .001;
        for (R && (t.push(x, w),
            x = v,
            w = y,
            v = t[m - 2],
            ...
            v === x && y === w || (o = b,
                ...
                b = x - v,
                M = w - y,
                h = ((s = $(o * o + i * i)) + (l = $(b * b + M * M))) * e * .25 / $(Math.pow(b / l + o / s, 2) + Math.pow(M / l + i / s, 2)),
                g = v - ((u = v - (v - n) * (s ? h / s : 0)) + (((f = v + (x - v) * (l ? h / l : 0)) - u) * (3 * s / (s + l) + .5) / 4 || 0)),
                d = y - ((c = y - (y - r) * (s ? h / s : 0)) + (((p = y + (w - y) * (l ? h / l : 0)) - c) * (3 * s / (s + l) + .5) / 4 || 0)),
            v === n && y === r || P.push(N(u + g), N(c + d), N(v), N(y), N(f + g), N(p + d)));
        return v !== x || y !== w || P.length < 4 ? P.push(N(x), N(w), N(x), N(w)) : P.length -= 2,
            2 === P.length ? P.push(v, y, v, y, v, y) : R && (P.splice(0, 6),
                P.length = P.length - 6),
            P
    }
    ...
    function R(t) {
        ...
        if (v = window,
            ...
            a && a.appendChild && (a.appendChild(n),
                n.appendChild(r),
    ...
    function Z(t, e) {
        if (t.parentNode && (c || R(t))) {
            ...
            return e && (n ? (b = b || Z(t),
                ...
                b.appendChild(l)) : (g || ((g = Z(t)).style.cssText = s),
    ...
    function aa(t, e) {
        var n, r, a, o, i, s, l = X(t), h = t === l, u = l ? G : q, f = t.parentNode;
        if (t === v)
            return t;
        if (u.length || u.push(Z(t, 1), Z(t, 2), Z(t, 3)),
            n = l ? b : g,
            l)
            h ? (o = -(a = function _getCTM(t) {
                var e, n = t.getCTM();
                return n || (e = t.style[k],
                    t.style[k] = "none",
                    t.appendChild(I),
                    n = I.getCTM(),
                    t.removeChild(I),
                ...
                i = -a.f / a.d,
                r = E) : t.getBBox ? (a = t.getBBox(),
                o = (r = (r = t.transform ? t.transform.baseVal : {}).numberOfItems ? 1 < r.numberOfItems ? function _consolidate(t) {
                    for (var e = new Y, n = 0; n < t.numberOfItems; n++)
                        e.multiply(t.getItem(n).matrix);
                    return e
                }(r) : r.getItem(0).matrix : E).a * a.x + r.c * a.y,
                i = r.b * a.x + r.d * a.y) : (r = new Y,
                o = i = 0),
            ...
            if (o = i = 0,
                ...
                for (r = t.offsetParent,
                    ...
                    4 < (v.getComputedStyle(a)[k] + "").length && (o = a.offsetLeft,
                        i = a.offsetTop,
                        a = 0);
    ...
    var c, v, w, P, g, b, E, I, D, n, k = "transform", z = k + "Origin", G = [], q = [], Y = ((n = Matrix2D.prototype).inverse = function inverse() {
        var t = this.a
            , e = this.b
            , n = this.c
            , r = this.d
        ...
        n.multiply = function multiply(t) {
            var e = this.a
                ...
                , f = t.e
                , g = t.f;
            return ba(this, s * e + h * r, s * n + h * a, l * e + u * r, l * n + u * a, o + f * e + g * r, i + f * n + g * a)
        }
        ,
    ...
    function qa(t, e, n, r, a, o, i, s, l) {
        return e = "cubic" === i.type ? [e] : (!1 !== i.fromCurrent && e.unshift(oa(n, r, s), a ? oa(n, a, l) : 0),
        i.relative && pa(e),
    ...
    function ua(t, e, n, r) {
        var a, o = getGlobalMatrix(t.parentNode, !0, !0), i = o.clone().multiply(getGlobalMatrix(e)), s = ta(t, n, o), l = ta(e, r, o), h = l.x, u = l.y;
        return i.e = i.f = 0,
        "auto" === r && e.getTotalLength && "path" === e.tagName.toLowerCase() && (a = e.getAttribute("d").match(et) || [],
            h += (a = i.apply({
                x: +a[0],
                y: +a[1]
            })).x,
            u += a.y),
        a && (h -= (a = i.apply(e.getBBox())).x,
            u -= a.y),
            i.e = h - s.x,
            i.f = u - s.y,
            i
    }
    var j, f, Q, W, J, o, K = "x,translateX,left,marginLeft,xPercent".split(","), tt = "y,translateY,top,marginTop,yPercent".split(","), i = Math.PI / 180, et = /[-+\.]*\d+\.?(?:e-|e\+)?\d*/g, nt = function _align(t, e, n) {
        var r, a, o, i = n.align, s = n.matrix, l = n.offsetX, h = n.offsetY, u = n.alignOrigin, f = t[0][0], g = t[0][1], c = oa(e, "x"), p = oa(e, "y");
        return t && t.length ? (i && ("self" === i || (r = W(i)[0] || e) === e ? transformRawPath(t, 1, 0, 0, 1, c - f, p - g) : (u && !1 !== u[2] ? j.set(e, {
            transformOrigin: 100 * u[0] + "% " + 100 * u[1] + "%"
        }) : u = [oa(e, "xPercent") / -100, oa(e, "yPercent") / -100],
            o = (a = ua(e, r, u, "auto")).apply({
                x: f,
                y: g
            }),
        ...
        init: function init(t, e, n) {
            ...
            var r, a, o = [], i = e.path, s = e.autoRotate, l = e.unitX, h = e.unitY, u = e.x, f = e.y, g = i[0], c = function _sliceModifier(e, n) {
                return function(t) {
            ...
            !Array.isArray(i) || "closed"in i || "number" == typeof g)
                ...
                for (a in g)
                    !u && ~K.indexOf(a) ? u = a : !f && ~tt.indexOf(a) && (f = a);
                for (a in u && f ? o.push(qa(this, na(na([], i, u, 0), i, f, 1), t, u, f, c, e, l || Q(i[0][u]), h || Q(i[0][f]))) : u = f = 0,
                    g)
