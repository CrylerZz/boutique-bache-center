    ...
    var f, a, T, i, c, y, h, v, r = {
        ...
        init: function init(e, r, l, s, i) {
            ...
            c && "none" !== c && (p.snap = 1,
                ...
                null != r.x ? (p.add(p, "x", p.x, t(r.x, e, "x", p.x, r.offsetX || 0), s, i),
                    p._props.push("scrollTo_x")) : p.skipX = 1,
                null != r.y ? (p.add(p, "y", p.y, t(r.y, e, "y", p.y, r.offsetY || 0), s, i),
        ...
        render: function render(e, t) {
            ...
            t.x < 0 && (t.x = 0),
            t.y < 0 && (t.y = 0),
            f && (!t.skipX && (s < l || l < -s) && o < p(c, "x") && (t.skipX = 1),
